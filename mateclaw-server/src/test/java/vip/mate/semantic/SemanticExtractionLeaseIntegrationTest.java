...
class SemanticExtractionLeaseIntegrationTest {
    ...
    Task task(String id,String workspace){return new Task(id,new Actor(workspace,"1"),"3","op-"+id,"hash-"+id,
        new SourceSnapshotInput("4","5","digest","甲😀乙",Map.of("title","fixture")),
        new OntologyRevision(new OntologyRevisionId("6"),new OntologyId("7"),1,new OntologyDefinition(List.of(),List.of(),List.of())),"definition","v1",new ModelConfiguration("8","fixture","hash",Map.of()),TaskStatus.QUEUED,1,false,now,now);}
    ...
    @Test void editWaitsForSubmissionGateAndCannotOvertakeReservedRevision()throws Exception{
        ...
        var raw=new RawSuggestion(new ObjectMention("s","Equipment","machine"),vip.mate.semantic.core.fact.PredicateRef.property("voltage"),new vip.mate.semantic.core.fact.StatementValue.DecimalValue("220","V"),null,vip.mate.semantic.core.fact.Validity.unknown(),List.of(new Quote(0,1,"甲")));
