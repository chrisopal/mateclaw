...
public class ExtractionConfiguration {
    ...
    @Bean MateClawModelAdapter extractionModel(ObjectProvider<ModelConfigService> models,ObjectProvider<ProviderChatModelFactory> factory,ObjectProvider<vip.mate.llm.service.ModelProviderService> providers,vip.mate.semantic.owl.OwlAssertionAdapter assertions){return new MateClawModelAdapter(models,factory,providers,assertions);}
