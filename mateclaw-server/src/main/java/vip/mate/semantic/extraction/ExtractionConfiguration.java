...
public class ExtractionConfiguration {
    ...
    @Bean MateClawModelAdapter extractionModel(ObjectProvider<ModelConfigService> models,ObjectProvider<ProviderChatModelFactory> factory){return new MateClawModelAdapter(models,factory);}
    ...
    @Bean ExtractionCoordinator extractionCoordinator(MateClawSourceAdapter sources,MateClawAccessAdapter access,MateClawContextAdapter context,JdbcExtractionRepository repo,MateClawModelAdapter model,Feature feature){return new ExtractionCoordinator(sources,access,context,repo,model,Clock.systemUTC(),feature::enabled);}
    @Bean SuggestionSubmissionService extractionSuggestionSubmission(MateClawAccessAdapter access,MateClawContextAdapter context,JdbcExtractionRepository repo,MateClawSubmissionAdapter submission){return new SuggestionSubmissionService(access,context,repo,submission);}
