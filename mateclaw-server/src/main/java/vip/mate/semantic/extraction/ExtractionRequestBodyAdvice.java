...
@ControllerAdvice(assignableTypes = ExtractionController.class)
public class ExtractionRequestBodyAdvice extends RequestBodyAdviceAdapter {
    ...
    public boolean supports(
        ...
        return targetType instanceof Class<?> type
                && type.getEnclosingClass() == ExtractionDtos.class;
    }
