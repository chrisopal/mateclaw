...
public final class OntologyDtos {
    ...
    public record Type(String key, String label, String description) {}
    ...
    public record Definition(
            List<Type> types, List<Property> properties, List<Relation> relations) {}
    ...
    public record Diff(String fromRevisionId, String toRevisionId, List<Change> changes) {}
