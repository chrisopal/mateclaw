CREATE TABLE mate_semantic_source_change_run (
 ...
 status VARCHAR(16) NOT NULL, expected_graph_version BIGINT, request_digest VARCHAR(64) NOT NULL, baseline_json TEXT NOT NULL, created_by VARCHAR(32) NOT NULL,
