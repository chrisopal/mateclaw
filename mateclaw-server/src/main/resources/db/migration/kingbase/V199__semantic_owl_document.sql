...
ALTER TABLE mate_semantic_ontology_revision ADD COLUMN document_text TEXT;
...
ALTER TABLE mate_semantic_ontology_revision ADD COLUMN imports_json TEXT;
ALTER TABLE mate_semantic_ontology_revision ADD COLUMN policy_json TEXT;
ALTER TABLE mate_semantic_ontology_revision ALTER COLUMN definition_json DROP NOT NULL;
...
ALTER TABLE mate_semantic_entity ADD COLUMN asserted_types_json TEXT;
ALTER TABLE mate_semantic_entity ADD CONSTRAINT uq_sem_entity_iri UNIQUE(graph_id,iri_digest);
ALTER TABLE mate_semantic_entity ALTER COLUMN type_key DROP NOT NULL;
...
CREATE TABLE mate_semantic_import_artifact (
 ...
 document_text TEXT NOT NULL, ontology_iri VARCHAR(2048), version_iri VARCHAR(2048),
...
CREATE TABLE mate_semantic_ontology_axiom (
 ...
 axiom_kind VARCHAR(64) NOT NULL, axiom_text TEXT NOT NULL, signature_json TEXT NOT NULL,
...
CREATE TABLE mate_semantic_axiom_source (
 ...
 source_snapshot_id VARCHAR(36), source_digest VARCHAR(64), exact_quote TEXT,
