...
CREATE TABLE mate_semantic_extraction_task (
 ...
 operation_id VARCHAR(128) NOT NULL, request_hash VARCHAR(64) NOT NULL, payload_json TEXT NOT NULL,
...
CREATE TABLE mate_semantic_extraction_attempt (
 ...
 generation BIGINT NOT NULL, payload_json TEXT NOT NULL, UNIQUE(task_id,attempt_number)
);
CREATE TABLE mate_semantic_extraction_suggestion (
 ...
 version BIGINT NOT NULL, status VARCHAR(16) NOT NULL, payload_json TEXT NOT NULL
);
...
CREATE TABLE mate_semantic_extraction_edit (
 suggestion_id VARCHAR(36) NOT NULL, version BIGINT NOT NULL, payload_json TEXT NOT NULL,
