...
ALTER TABLE mate_semantic_statement_revision ADD COLUMN assertion_text TEXT;
ALTER TABLE mate_semantic_statement_revision ALTER COLUMN predicate_key DROP NOT NULL;
