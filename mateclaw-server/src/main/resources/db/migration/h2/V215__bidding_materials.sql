CREATE TABLE mate_bidding_handoff (
 ...
 solution_ref VARCHAR(128) NOT NULL, snapshot_json CLOB NOT NULL, digest VARCHAR(64) NOT NULL,
...
CREATE TABLE mate_bidding_material (
 ...
 digest VARCHAR(64) NOT NULL, content_json CLOB NOT NULL, access_ref_json CLOB NOT NULL,
 validity VARCHAR(32) NOT NULL, created_at TIMESTAMP NOT NULL,
 UNIQUE(workspace_id,project_id,external_id,version,digest)
);
