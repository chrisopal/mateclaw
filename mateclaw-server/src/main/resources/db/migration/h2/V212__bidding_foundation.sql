CREATE TABLE mate_bidding_project (
 ...
 stage VARCHAR(32) NOT NULL, body_json CLOB NOT NULL, created_at TIMESTAMP NOT NULL, updated_at TIMESTAMP NOT NULL
);
...
CREATE TABLE mate_bidding_source (
 ...
 content BLOB NOT NULL, blocks_json CLOB NOT NULL, quality VARCHAR(32) NOT NULL, read_token VARCHAR(128), read_started_at TIMESTAMP,
 created_at TIMESTAMP NOT NULL, UNIQUE(project_id,source_id,version)
);
CREATE TABLE mate_bidding_head (
 ...
 version INTEGER NOT NULL, selected_ref_json CLOB NOT NULL, PRIMARY KEY(workspace_id,project_id,kind,object_id)
);
CREATE TABLE mate_bidding_revision (
 ...
 object_id VARCHAR(64) NOT NULL, version INTEGER NOT NULL, payload_json CLOB NOT NULL, input_refs_json CLOB NOT NULL,
 status VARCHAR(32) NOT NULL, digest VARCHAR(64) NOT NULL, created_at TIMESTAMP NOT NULL,
 UNIQUE(workspace_id,project_id,kind,object_id,version)
);
...
CREATE TABLE mate_bidding_task (
 ...
 skill_package_id VARCHAR(64) NOT NULL, config_digest VARCHAR(64) NOT NULL, input_json CLOB NOT NULL, input_refs_json CLOB NOT NULL,
 status VARCHAR(32) NOT NULL, active_attempt_id VARCHAR(64), deadline_at TIMESTAMP, cycle_no INTEGER NOT NULL DEFAULT 0,
 cycle_attempt INTEGER NOT NULL DEFAULT 0, attempt_count INTEGER NOT NULL DEFAULT 0, next_run_at TIMESTAMP, boot_id VARCHAR(64),
...
CREATE TABLE mate_bidding_attempt (
 ...
 attempt_no INTEGER NOT NULL, token VARCHAR(128) NOT NULL UNIQUE, state VARCHAR(32) NOT NULL, output_json CLOB,
 tool_receipts_json CLOB NOT NULL, rejected_output CLOB, error_json CLOB, started_at TIMESTAMP, finished_at TIMESTAMP,
 UNIQUE(task_id,attempt_no)
);
CREATE TABLE mate_bidding_decision (
 id VARCHAR(64) PRIMARY KEY, workspace_id VARCHAR(64) NOT NULL, project_id VARCHAR(64) NOT NULL, target_ref_json CLOB NOT NULL,
 decision VARCHAR(32) NOT NULL, reason CLOB, actor_id VARCHAR(64) NOT NULL, created_at TIMESTAMP NOT NULL
);
CREATE TABLE mate_bidding_operation (
 ...
 request_digest VARCHAR(64) NOT NULL, result_json CLOB NOT NULL, created_at TIMESTAMP NOT NULL,
...
CREATE TABLE mate_bidding_skill_package (
 ...
 version VARCHAR(128) NOT NULL, digest VARCHAR(64) NOT NULL, files_json CLOB NOT NULL, created_at TIMESTAMP NOT NULL
);
