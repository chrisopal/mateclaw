CREATE TABLE mate_presales_project (
 ...
 name VARCHAR(300) NOT NULL, status VARCHAR(32) NOT NULL, body_json LONGTEXT NOT NULL
);
...
CREATE TABLE mate_presales_operation (
 ...
 request_hash VARCHAR(64) NOT NULL, response_json LONGTEXT NOT NULL,
...
CREATE TABLE mate_presales_revision (
 ...
 action VARCHAR(64) NOT NULL, body_json LONGTEXT NOT NULL, created_at TIMESTAMP NOT NULL,
...
CREATE TABLE mate_presales_artifact (
 ...
 digest VARCHAR(64) NOT NULL, content_base64 LONGTEXT NOT NULL,
