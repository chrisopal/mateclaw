CREATE TABLE mate_semantic_graph_migration_plan (
 ...
 source_version INT NOT NULL, target_version INT NOT NULL,
 ...
 mapping_json LONGTEXT NOT NULL, payload_json LONGTEXT NOT NULL, impact_json LONGTEXT NOT NULL,
 ...
 created_at DATETIME(6) NOT NULL, approved_at DATETIME(6), executed_at DATETIME(6), rolled_back_at DATETIME(6),
