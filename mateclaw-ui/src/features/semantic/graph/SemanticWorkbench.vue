...
const tab = ref('facts'), error = ref(''), busy = ref(false), generation = ref(0), reason = ref(''), page = ref(1), totals = ref<Record<string, number>>({})
