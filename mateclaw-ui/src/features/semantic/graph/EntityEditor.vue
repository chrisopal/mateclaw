...
interface EntityTypeOption { iri: string; label: string }
const props = defineProps<{ graphId: string; classOptions?: EntityTypeOption[] }>(); const emit = defineEmits<{ saved: [] }>(); const { t } = useI18n(); const { begin } = useSemanticScope()
