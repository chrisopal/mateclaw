export default {
  ...
  "states": {
    ...
    w: {
      ...
      states: {"ACTIVE": "有效来源", "WITHDRAWN": "已撤回", "OPEN": "待处理", "RESOLVED": "已解决", "SINGLE_VALUE_DISAGREEMENT": "同一事项存在不同记录", "TEMPORAL_UNCERTAINTY": "适用时间待核实", "PROPOSED": "待确认", "ACCEPTED": "已确认", "UNREVIEWED": "尚未审核", "SUPPORT_LOST": "证据支持已撤回", "SUPPORTED": "有证据支持", "UNSUPPORTED": "证据支持已撤回", "PENDING": "待审核", "CONFIRMED": "已确认", "REJECTED": "未采纳", "RETRACTED": "已撤回", "CONFLICTED": "存在冲突"},
      "title": "知识工作台",
      "workbench": "知识工作台",
