export default {
  semantic: {
    ...
    w: {
      ...
      "type": "Entity type",
      "name": "Name",
      "addEntity": "Register entity",
      "captureHelp": "Select a knowledge-base source to capture immutable text. Capture does not extract facts.",
      ...
      "validTo": "Valid to",
      "snapshot": "Snapshot",
      "selectHelp": "Select an exact passage in the fixed text below. Offsets count Unicode code points.",
      "snapshotText": "Fixed snapshot text",
      ...
      "empty": "No records",
      "keepWinner": "Keep this statement",
      "sources": "Sources",
      "status": "Status",
      ...
      "version": "Version",
      "digest": "Text digest",
      "excludeSnapshot": "Exclude this snapshot only",
      ...
      "queue": "Candidate and fact queue",
