export default {
  semantic: {
    modelStructure: "Ontology structure",
    advancedDocument: "Advanced OWL document",
    modelStale: "The graph shows the saved draft. Save current changes to refresh it.",
    migration: {"title": "Ontology revision upgrade", "help": "Prepare an impact report, then approve the switch. Original fact revisions remain available. New graph writes block direct rollback.", "target": "Published target revision", "mappingHelp": "Unchanged IRIs need no mapping. Map classes, properties and individuals separately; no automatic entity merge or unit conversion.", "classes": "Classes", "objectProperties": "Object properties", "dataProperties": "Data properties", "individuals": "Individuals", "from": "Source IRI", "to": "Target IRI", "addMapping": "Add mapping", "prepare": "Prepare upgrade plan", "planId": "Upgrade plan ID", "reload": "Read plan", "counts": "Interpretation changes: {entities} entities and {facts} facts.", "truncated": "Incomplete impact report; upgrade is blocked.", "oldAssertion": "Original assertion", "newAssertion": "Target assertion", "approve": "Approve this plan", "execute": "Execute approved switch", "rollback": "Restore original interpretation"},
    extraction: {
      errors: {
        QUOTE_MISMATCH: "The quote cannot be located exactly. Select the source passage again.",
        EVIDENCE_REQUIRED: "Select at least one source passage.",
        OBJECT_SELECTION_REQUIRED: "Select the registered business object.",
        VALUE_ABOVE_MAXIMUM: "The value exceeds the ontology maximum.",
        UNIT_MISMATCH: "The unit does not match the ontology.",
  "TIMEOUT": "The model timed out. Retry later.",
  "RATE_LIMIT": "The model is rate limited. Retry later.",
  "MODEL_FORMAT": "The model returned an invalid format. Retry or contact an administrator.",
  "MODEL_UNAVAILABLE": "The selected model is unavailable. Check its configuration.",
  "MODEL_AUTHORIZATION": "Model authorization failed. Ask an administrator to check credentials.",
  "MODEL_CONFIGURATION_CHANGED": "Model configuration changed. Start a new task.",
  "BINDING_CHANGED": "Ontology binding changed. Start a new task.",
  "SOURCE_UNAVAILABLE": "The source was withdrawn or is inaccessible. Choose another source.",
  "SNAPSHOT_EXCLUDED": "This source version was excluded. Capture the source again.",
  "ATTEMPT_LIMIT": "The attempt limit was reached. Check the failure before starting a new task.",
  "LEASE_LOST": "Another worker took over this task. Refresh its status.",
  "TASK_BUDGET_EXCEEDED": "The execution budget was exceeded. Use a smaller source.",
  "MODEL_OUTPUT_LIMIT": "The output exceeds the limit. Use a smaller source.",
  "EXTRACTION_FAILED": "Generation did not complete. Refresh or contact an administrator with the task ID.",
  "EXTRACTION_DISABLED": "Assisted generation is disabled. Existing knowledge remains available.",
  "TEMPORARY_UNAVAILABLE": "The model is temporarily unavailable. Retry later."
},
  "title": "Generate from source",
  "help": "Generate suggestions using the bound ontology. Check objects and evidence before submitting for review.",
  "disabled": "Assisted generation is disabled. You can still add knowledge manually or read existing tasks.",
  "source": "Source document",
  "model": "Model",
  "noModel": "No model available. Ask an administrator to configure one.",
  "sendNotice": "Source text and ontology definitions will be sent to this model. Suggestions require human review and do not automatically become confirmed knowledge.",
  "binding": "Ontology revision:",
  "start": "Generate suggestions",
  "history": "Existing tasks",
  "selectTask": "Select task",
  "suggestions": "Suggestions ({count})",
  "empty": "Processing completed with no extractable knowledge. Check the source or add knowledge manually.",
  "cancel": "Stop generation",
  "retry": "Retry task",
  "taskContext": "Model: {model} · Attempts: {attempt}",
  "progress": "Processed {done} / {total} chunks. The task continues after you leave.",
  "evidenceHelp": "Check that the highlighted source supports the complete suggestion.",
  "invalidQuote": "Quote does not match the source. Select evidence again.",
  "reselect": "Select source passage",
  "reviewSuggestion": "Review suggestion",
  "matchHelp": "Source mentions {name}. Select a registered object; identical names do not establish identity.",
  "registerHelp": "Missing object? Register it in Business objects first",
  "saveBeforeSubmit": "Content changed. Save before submitting.",
  "saveReview": "Save review",
  "submit": "Submit for review",
  "ignore": "Ignore suggestion",
  "openStatement": "Open knowledge record",
  "states": {
    "QUEUED": "Queued",
    "RUNNING": "Generating",
    ...
    changeReasons: {
      ...
      DECIMAL_RANGE_CHANGED: 'Decimal range changed',
      DEPRECATION_CHANGED: 'Deprecation changed',
      DESCRIPTION_CHANGED: 'Description changed',
      ENUMERATION_CHANGED: 'Enumeration changed',
      ENUMERATION_EXPANDED: 'Enumeration expanded',
      ENUMERATION_REDUCED: 'Enumeration reduced',
      FIXED_UNIT_CHANGED: 'Fixed unit changed',
      LABEL_CHANGED: 'Label changed',
      MULTIPLICITY_CHANGED: 'Multiplicity changed',
      OWNER_TYPE_CHANGED: 'Owner type changed',
      SOURCE_TYPE_CHANGED: 'Source type changed',
      TARGET_TYPE_CHANGED: 'Target type changed',
      TERM_ADDED: 'Term added',
      TERM_REMOVED: 'Term removed',
      VALUE_TYPE_CHANGED: 'Value type changed',
    },
    scanSummary: 'Scanned: {entities} entities · {statements} facts · {proposals} proposals',
    affectedSummary: 'Affected: {entities} entities · {statements} facts · {proposals} proposals',
    termSearch: 'Search key, name or alias',
    w: {
      entitiesHelp: "Add specific batches, equipment or issues. Knowledge records will refer to these objects.",
      conflictsHelp: "Compare the evidence behind different accounts and decide which record to accept.",
      changesHelp: "Review requested changes to existing knowledge. Approval creates a new revision and preserves the previous record.",
      candidateHelp: "Choose an object, enter a value or related object, and cite a source passage. An administrator reviews the submission.",
      memberQueueHelp: "Browse your submissions and their status. Open a record to inspect its content and evidence.",
      queueHelp: "Browse submitted, confirmed and rejected records. Open a record to review its content and evidence.",
      workbenchHelp: "Add knowledge from source materials. It becomes available to queries after review; request changes when evidence or conclusions change.",
      ...
      noFacts: "No confirmed knowledge yet. Add a record with source evidence and submit it for review.",
      noCandidates: "No knowledge records yet. Add business objects, save source versions, then add knowledge.",
      graphLabel: "Confirmed object relationships",
      graphEmpty: "This object has no confirmed relationships yet. Property records are listed below.",
      graphExplore: "Browse objects and relationships (keyboard accessible)",
      states: {"ASSERTION_CONTRADICTION": "Contradictory assertions", "BUSINESS_SINGLE_VALUE": "Business single-value conflict", "BUSINESS_TEMPORAL_UNCERTAINTY": "Uncertain time for business single-value records", "ACTIVE": "Active", "WITHDRAWN": "Withdrawn", "OPEN": "Open", "RESOLVED": "Resolved", "SINGLE_VALUE_DISAGREEMENT": "Single-value disagreement", "TEMPORAL_UNCERTAINTY": "Temporal uncertainty", "PROPOSED": "Candidate · unverified", "ACCEPTED": "Accepted", "UNREVIEWED": "Unreviewed", "SUPPORT_LOST": "Support lost", "SUPPORTED": "Supported", "UNSUPPORTED": "Support withdrawn", "PENDING": "Pending review", "CONFIRMED": "Confirmed", "REJECTED": "Rejected", "RETRACTED": "Retracted", "CONFLICTED": "Conflicted"},
      "title": "Knowledge workbench",
      "workbench": "Knowledge workbench",
      "chooseKnowledgeBase": "Choose a knowledge base",
      "noBindings": "No knowledge bases bound",
      "goToKnowledgeBases": "Go to knowledge bases",
      "openWorkbench": "Open knowledge workbench",
      "type": "Object type",
      "name": "Name",
      "addEntity": "Add object",
      "captureHelp": "Save a version of the source text, then cite a passage to add knowledge. Saving a source does not generate knowledge automatically.",
      "material": "Knowledge-base material",
      "capture": "Save source version",
      "refresh": "Refresh",
      "retry": "Retry",
      ...
      "value": "Value",
      "validity": "Applies during",
      "interval": "Specific time range",
      "unknown": "Time not established",
      "validFrom": "Valid from (optional); valid to (optional)",
      "validTo": "Valid to",
      "snapshot": "Source version",
      "selectHelp": "Select the passage that supports this record. Its citation location will be saved automatically.",
      "snapshotText": "Saved source text",
      "proposeChange": "Request a change",
      "propose": "Add knowledge",
      "changeBase": "Change {id} from revision {revision}",
      "evidenceUnavailable": "Evidence unavailable or support withdrawn",
      "evidence": "Evidence",
      ...
      "accept": "Accept",
      "reject": "Reject",
      "retract": "Withdraw knowledge",
      "history": "Revision history",
      "empty": "No records",
      "keepWinner": "Use this record",
      "sources": "Sources and evidence",
      "status": "Status",
      "withdrawSource": "Withdraw entire source",
      "snapshots": "Source versions",
      "version": "Version",
      "digest": "Text digest",
      "excludeSnapshot": "Exclude this source version",
      "ontologyVersion": "Ontology version",
      "graphVersion": "Graph version",
      "facts": "Confirmed knowledge",
      "truncated": "Graph limit reached. Select another entity to explore its neighborhood.",
      "support": "Evidence status",
      "entities": "Business objects",
      "newCandidate": "Add another record",
      "queue": "Knowledge records",
      "changes": "Change requests",
      "conflicts": "Resolve disagreements",
      "sourceChanges": "Source changes",
      "sourceChangesHelp": "Scan pinned sources for changed snapshots and review the affected records before deciding what to do.",
      "sourceChangesNoRewrite": "A review decision records human judgment. It does not automatically rewrite, withdraw, or re-approve a knowledge record.",
      "scanSourceChanges": "Scan source changes",
      "sourceChangesFound": "Detected source changes",
      "noSourceChanges": "No source changes detected in this scan.",
      "sourceChangeItems": "Affected records",
      "noSourceChangeItems": "No affected records are waiting for review.",
      "sourceChangeDecisionHint": "Review the source digest and record before deciding. The graph version and observed digest are checked when you submit.",
      "sourceChangeDecision": "Review decision",
      "sourceChangeDecide": "Save review decision",
      "source": "Source",
      "item": "Record type",
      "record": "Record"
},
    violations: {
    "EMPTY_TYPES": "Add at least one entity type.",
    "REQUIRED": "Complete this field or definition.",
    "FIELD_TOO_LONG": "Shorten this field: keys allow 64 characters, names 128, descriptions 1000 and units 32.",
    "INVALID_KEY": "Start the key with a letter; use only letters, digits and underscores.",
    "UNKNOWN_TYPE": "The referenced type does not exist. Create it or select another type.",
    "UNIT_REQUIRES_DECIMAL": "Fixed units require Decimal. Select Decimal or clear the unit.",
    "DUPLICATE_KEY": "This category already contains the key. Use a unique key.",
    "TOO_MANY_DEFINITIONS": "Limit definitions to 100 types and 500 properties and relations combined.",
    "INVALID_REQUEST": "Check the input field format."
},
    pendingPublication: "Publication outcome is uncertain. Editing is paused. Recover the original operation to continue.",
    recoverPublication: "Recover publication",
    "title": "Ontologies",
    "generateFromSource": "Generate from source",
    "boundary": "Maintain enterprise objects, properties and relations, and publish traceable ontology versions.",
    "create": "New ontology",
    "search": "Search ontology names",
    "searchAction": "Search",
    "name": "Name",
    ...
    "empty": "No ontologies yet. Create one to get started.",
    "cancel": "Cancel",
    "retry": "Retry",
    "back": "Back to list",
    "save": "Save draft",
    ...
    "saved": "Saved",
    "readonly": "Your access allows viewing only. Definitions cannot be edited.",
    "draftVersion": "Draft revision",
    "key": "Key",
    "label": "Label",
    ...
    "aliases": "Aliases",
    "aliasesHelp": "Optional search and display hints. Keep the stable key unchanged.",
    "aliasPlaceholder": "Add an alias and press Enter",
    "deprecated": "Mark as deprecated",
    "allowedValues": "Allowed values",
    "allowedValuesHelp": "One exact value per line. Values are case-sensitive.",
    "allowedValuesPlaceholder": "Pending review\nConfirmed",
    "minimum": "Minimum",
    "maximum": "Maximum",
    "constraints": "Constraints",
    "code": "Code",
    "reasons": "Reasons",
    "entityDiagnostic": "Entity",
    "statementDiagnostic": "Statement",
    "changeProposalDiagnostic": "Change proposal",
    "diagnosticCodes": {
      VALUE_ABOVE_MAXIMUM: 'Above target maximum',
      VALUE_BELOW_MINIMUM: 'Below target minimum',
      VALUE_NOT_ALLOWED: 'Outside target allowed values',
      VALUE_TYPE_MISMATCH: 'Value type differs from target',
      VALUE_ENTITY_TYPE_MISMATCH: 'Relation target type mismatch',
      UNKNOWN_SUBJECT: 'Subject entity missing',
      SUBJECT_TYPE_MISMATCH: 'Subject type mismatch',
      UNKNOWN_PREDICATE: 'Predicate absent from target',
      UNIT_MISMATCH: 'Fixed unit mismatch',
      "UNKNOWN_ENTITY_TYPE": "Entity type missing",
      "SINGLE_VALUE_DISAGREEMENT": "Single-value disagreement",
      "TEMPORAL_UNCERTAINTY": "Temporal uncertainty",
      "IMPACT_STALE": "Data changed during analysis",
      "IMPACT_INCOMPLETE": "Scan incomplete"
    },
    "decimalHelp": "Optional inclusive decimal boundary; do not use exponent notation.",
    "sourceTypeKey": "Source type",
    "targetTypeKey": "Target type",
    "validation": "Validation",
    "validationStale": "Validation expired after editing. Save and validate again.",
    "validationPassed": "The saved draft passed validation and is ready to publish.",
    "validationRequired": "Save and validate the draft before publishing.",
    "field": "Field path",
    "issue": "Issue",
    "locate": "Locate",
    "types": "Types",
    ...
    "delete": "Delete",
    "emptyDefinitions": "No definitions",
    "duplicateKey": "This key already exists. Use a unique key.",
    "referenced": "Properties or relations reference this type. Remove references before deleting or renaming its key.",
    "deleteWarning": "Delete definition {key}? Takes effect after saving the draft.",
    "leaveWarning": "You have unsaved changes. Leaving will lose this input.",
    "leave": "Discard changes and leave",
    "stay": "Keep editing",
    "discardWarning": "Discard this draft? Published versions remain intact.",
    "publishHelp": "Publish the saved, validated draft as an immutable version. If the result is uncertain, retry continues the same publication operation.",
    "publicationNote": "Publication note",
    "confirmPublish": "Confirm publication",
    "change": "Change",
    "category": "Category",
    "noChanges": "No differences",
    "historyHelp": "Published content is read-only. Select a version to copy into a new draft.",
    "openDraft": "Open draft",
    "copyDraft": "Create draft from selection",
    "newDraft": "Create draft",
    "noVersions": "No published versions",
    "availability": "New binding availability",
    "availabilityWarning": "This only changes selection for future bindings. Published content remains intact.",
    "confirm": "Confirm",
    "publishedAt": "Published at",
    "publishedBy": "Published by",
    "available": "Available for new bindings",
    "unavailable": "Unavailable for new bindings",
    "bindingTitle": "Enterprise knowledge graph binding",
    "bindingHelp": "Pin this knowledge base to one published ontology revision. A graph with content cannot be rebound.",
    "usage": "Usage",
    "usageHelp": "Knowledge graphs currently bound to this ontology. Only accessible graphs are listed.",
    "noUsage": "No knowledge graph is using this ontology.",
    "knowledgeBase": "Knowledge base",
    "enabled": "Enabled",
    "disabled": "Disabled",
    "analyzeImpact": "Analyze impact",
    "impact": "Impact analysis",
    "impactHelp": "Analysis is read-only. It does not migrate or rebind an existing graph.",
    "impactTarget": "Target",
    "impactDraft": "Saved draft",
    "impactRevision": "Published revision",
    "runAnalysis": "Run analysis",
    "analysisRequired": "Save the draft before analyzing impact.",
    "analysisIncomplete": "The scan did not complete. Treat this result as incomplete.",
    "analysisExpired": "The draft or graph changed; run the analysis again.",
    "detailsTruncated": "Showing the first {count} diagnostics; totals include all scanned records.",
    "definitionChangeClass": "Definition change",
    "dataConformance": "Data conformance",
    "scanned": "Scanned",
    "scannedAt": "Scanned at",
    "graphVersion": "Graph version",
    "affected": "Affected",
    "diagnostics": "Diagnostics",
    "noDiagnostics": "No diagnostics were returned.",
    "conforms": "Conforms",
    "dataViolations": "Violations",
    "incomplete": "Incomplete",
    "annotation": "Annotation",
    "additiveOrWidening": "Additive or widening",
    "potentiallyBreaking": "Potentially breaking",
    "breaking": "Breaking",
    "exportTemplate": "Export template",
    "exportFunctional": "Export Functional",
    "exportRdfXml": "Export RDF/XML",
    "document": "Document",
    "documentText": "OWL Functional Syntax document",
    "axioms": "Axioms",
    "emptyAxioms": "No axioms",
    "axiomCount": "Axioms: {count}",
    "importCount": "Imports: {count}",
    "sourceBindings": "Axiom sources",
    "sourceBindingsHelp": "Pin exact source evidence to an OWL axiom; published snapshots remain immutable.",
    "noSourceBindings": "No axiom sources",
    "sourceReviews": "Source reviews",
    "noSourceReviews": "No pending source reviews",
    "scanSources": "Scan source changes",
    ...
    "remodel": "Remodel",
    "compareSources": "Compare source versions",
    "originalSource": "Original source",
    "observedSource": "Observed source",
    "sourceUnavailable": "Source unavailable; original snapshot retained.",
    "keepHistorical": "Keep historical",
    "importTemplate": "Import template",
    "importTitle": "Import ontology template",
    "importHelp": "Preview the package first, then create a new ontology draft. Existing ontologies are never overwritten.",
    "choosePackage": "Choose ontology file or JSON package",
    "preview": "Preview",
    "previewReady": "Package preview passed. Review the counts before creating a draft.",
    "previewRejected": "Package preview found issues. Correct the package and preview again.",
    "packageName": "New ontology name",
    "packageSummary": "Package summary",
    "typeCount": "Types: {count}",
    "predicateCount": "Properties and relations: {count}",
    "importDraft": "Create draft",
    "importRecovery": "The import request may have committed. Recover by operation ID.",
    "recoverImport": "Recover import",
    "importedDraft": "Draft created. Opening the editor…",
    "bindingRevision": "Ontology revision",
    "bindingEnabled": "Enabled",
    "bindingDisabled": "Disabled",
    "bind": "Create binding",
    "enableBinding": "Enable again",
    "disableBinding": "Disable binding",
    "rebind": "Change revision",
    "pinnedVersion": "Pinned to v{version}",
    "graphEmpty": "Graph is empty and can be rebound",
    "graphNotEmpty": "Graph has content and cannot be rebound",
    "disableAvailability": "Disable new bindings",
    "enableAvailability": "Enable new bindings",
    "compare": "Compare versions",
    "from": "From version",
    "to": "To version",
    "emptyBaseline": "Empty baseline",
    "before": "Before",
    "after": "After",
    ...
    "errors": {
        "DRAFT_CONFLICT": "Another editor changed the draft. Your input is preserved; copy it before reloading to reconcile.",
        "DRAFT_EXISTS": "A draft already exists. Open it to continue editing.",
        "NOT_FOUND": "Resource not found in this workspace.",
        "VALIDATION_FAILED": "Validation failed. Correct the indicated fields.",
        "OPERATION_CONFLICT": "Publication operation conflict. Reload to verify the result.",
        "GRAPH_NOT_EMPTY": "The graph has entities, sources, or facts and cannot be rebound.",
        "GRAPH_VERSION_CONFLICT": "Another administrator changed this binding. Reload and retry.",
      "REVISION_UNAVAILABLE": "This ontology revision is closed to new bindings.",
      "DEFINITION_FORMAT_DOWNGRADE": "This draft contains newer definition fields. Refresh before saving with an older client.",
      "PACKAGE_DIGEST_CONFLICT": "The package changed after preview. Preview it again.",
      "IMPORT_OPERATION_CONFLICT": "This import operation was already used with different package content.",
      "IMPACT_INCOMPLETE": "Impact analysis did not finish. No clean result was produced; retry the scan.",
      "IMPACT_STALE": "The graph or draft changed during analysis. Run it again.",
